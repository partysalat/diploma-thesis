...
Als Algorithmus ergibt sich folglich
 ...
 \Function{calc\_kink\_partials}{$\cx,\hx,d$}
 	...
 	\Repeat
 	  ...
 	  \State $\hat{\tau} \gets \Call{critMult}{ x_{kink},d}$ 		 \Comment{Berechne kritischen Multiplikator}
...
\end{align*}
Dies entspricht der verallgemeinerten impliziten Mittelpunktsregel \eqref{eq:genMidpointRule}.
