...
\begin{aligned}
 ...
 &= \langle F'(t)\gatdiff x(t),\gatdiff'x(t)\rangle - \langle \gardiff x(t),F'^*(t)\gatdiff x(t)\rangle\\
 &= 0
\end{aligned}
\end{equation}
