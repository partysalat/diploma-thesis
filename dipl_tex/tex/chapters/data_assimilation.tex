...
Die 4-D variationelle Datenassimilation ist eine Methode, die im Zusammenhang mit hyperbolischen partiellen Differentialgleichungen steht, z.B. der Wellengleichung. Benutzt wird dieses Verfahren meist in athmosphärischen Modellen, um optimale Parameter zur numerischen Wettervorhersage zu finden. Auch in ozeanographischen Modellen findet diese Methode Anwendung. Eingeführt von Talagrand und Le Dimet in \cite{dimet1986variational} finden die Methoden der optimalen Steuerung immer mehr Verwendung in realen Anwendungsgebieten (z.B. \cite{korotaev2008retrieving,elbern20004d,broquet2009application}).
