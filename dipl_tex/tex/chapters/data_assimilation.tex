...
\end{equation}
Der adjungierte Operator $R^*(t,0)$ des Resolventen $R(t,0)$ wird durch die Lösung der adjungierten Gleichung von \eqref{eq:tlm} 
\begin{equation}
\label{eq:adjointtlm}
