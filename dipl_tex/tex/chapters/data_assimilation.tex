...
Dass \eqref{eq:solutionInhAdjEquation} die inhomomgene adjungierte Gleichung \eqref{eq:inhAdjEquation} löst, lässt sich mittels der Eigenschaften des Resolventen \eqref{eq:resolventPropertiesA} und \eqref{eq:resolventPropertiesB} zeigen. Durch Substituieren erhält man
\begin{equation*}
 \begin{aligned}
...
\[
 f(x+\sigma d) \leq J(x) - c\left( \frac{\nabla J(x)^\tr d}{\|d\|}\right)^2
\]
