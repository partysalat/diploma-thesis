...
%Kink Berechnung
Um diese Kinks aus der Abs-Normal Form zu berechnenAus der Abs-Normal Form 
...
\end{figure}
Das bedeuted, dass wir das Intervall $[0,\frac{1}{2}]$ in $k$-Abschnitte zerlegen können mit reellen Zahlen $0=\tau_0<\tau_1<\ldots<\tau_k = \sfrac{1}{2}$,  sodass
\[
