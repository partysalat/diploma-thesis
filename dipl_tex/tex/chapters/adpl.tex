...
TODO: RADEMACHER EINFÜGEN -> Grundvoraussetzung zur diffbarkeit von pl functions
...
Die Klasse der verketteten glatten Funktionen kann als Erweiterung der stückweisen affinen Funktionen betrachtet werden. Sie bestehen aus $C^{1,1}$ Auswahlfunktionen, welche durch die unglatten Operationen $max$, $min$ und $abs$ verknüpft sind.
