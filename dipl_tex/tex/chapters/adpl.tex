...
\footnote{In dieser Arbeit nutzen wir "linear" synonym zu "affin" (oder "polyhedral"), da sich jede affine Funktion in eine lineare Funktion  transformieren lässt. Sie entsprechen den Begriffen bei Griewank \cite{monster} und Scholtes \cite{scholtes2012introduction}}
Funktionen
