...
anzuwenden. Diese werden auch für glatte Modelle benötigt. In der numerischen Berechnung partieller Differentialgleichungen wird beispielsweise bei den Finiten Volumen Methoden sogenannte \textit{Flux Limiter} benötigt. Diese sind stückweise lineare Funktionen, welche benutzt werden um oszillatorisches Verhalten in der Lösung zu minb
